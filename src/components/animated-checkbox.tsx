...
const AnimatedCheckbox = (props: Props) => {
  ...
  const animatedBoxProps = useAnimatedProps(
    () => ({
      stroke: interpolateColor(
        ...
        [0, 1],
        [boxOutlineColor, checkmarkColor],
        'RGB'
      ),
  ...
  return (
    <Svg viewBox={[-MARGIN, -MARGIN, vWidth + MARGIN, vHeight + MARGIN].join(" ")}>
      ...
      <AnimatedStroke progress={progress} d={checkMarkPath} stroke={highlightColor} strokeWidth={10} strokeLinejoin="round" strokeLinecap="round" strokeOpacity={checked ? 1 : 0} />
